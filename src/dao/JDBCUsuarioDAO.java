...
public class JDBCUsuarioDAO extends JDBCDAO implements UsuarioDAO {
	...
	public void cadastrar(Usuario usuario) {
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Falha ao cadastrar usuários em JDBCUsuaruioDAO.", e);
		} finally {
			super.close();
		}
	...
	public void editarNivel(Usuario usuario) {
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Erro ao editar nível de usuario.");
		} finally {
			super.close();
		}
	...
	public void salvarToken(String token, int id_usuario) {
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Erro ao gravar token do usuário.",e);
		} finally {
			super.close();
		}
	}
